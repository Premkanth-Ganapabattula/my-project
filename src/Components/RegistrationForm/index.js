    ...
    renderGenderFeild() {
        ...
        return (
            <div>
                ...
                <br />
                <select id="genderEle" value={gender} autoComplete='off' className='select-element' onChange={this.onChangeGenderElement}>
            ...
            <div className="registration-form-container">
                ...
                <form className='form-container-res' onSubmit={this.onSubmitRegistrationForm}>
                    ...
                    <div className='signup-button-container'>
                        <button type='submit' className='signup-button'>Sing Up</button>
